function New-NBKIncident {
    <#
        ...
        .EXAMPLE
        New-NBKPIncident -SDSCRPT "text input string" -Details "More text" -vm cmdb_item  
    ...
    #>
        ...
        New-ServiceNowIncident -Caller "$global:username" -ShortDescription $SDSCRPT -Description $DETAILS -Category "System Issue" -AssignmentGroup "Infrastructure Services - IT Backup" -ConfigurationItem "$VM" -CustomFields @{ impact = "3"
            Priority = "4"
            u_service = "Backups"
