function Get-MyWork {
    ...
    #>
        ...
        param(
            ...
            [ValidateSet("sc_task","problem","incident","change_request","sc_req_item","sc_request","change_task")]
            [string]
            $Table,
            ...
            [Parameter(HelpMessage = "Review Help - get-help Get-MyWork")]
        ...
        if (!$Filter) {
            ...
            $Filter = @('assigned_to','-like',"$username"),'and',@('state','-lt',3)
            try {
